...
const drawFrame = (time) => {
  clear();
  drawFilledCircle((time / 6) % width, height / 7, 35, 'black');
  ...
  drawFilledCircle((time/ 6.1) % width, height/ 2, 35, ' black')
  ...
  drawFilledCircle((time/ 4) % width, height/ 2.1, 35, ' black')
  drawFilledCircle((time/ 5) % width, height/ 1.5, 35, ' black')
