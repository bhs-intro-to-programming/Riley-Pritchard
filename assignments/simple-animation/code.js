...
const drawFrame = (time) => {
  clear();
  drawFilledCircle((time / 2) % width/ 1.1, height / 2, 25, 'purple');
  drawFilledCircle((time / 2.5) % width/ 1, height / 2, 25, 'blue');
  drawFilledCircle((time / 3.1) % width/ 1, height / 2, 25, 'green');
  drawFilledCircle((time / 3.9) % width/ 1, height / 2, 25, 'yellow');
  drawFilledCircle((time / 4.9) % width/ 1, height / 2, 25, 'orange');
  drawFilledCircle((time / 6.3) % width/ 1, height / 2, 25, 'red');
